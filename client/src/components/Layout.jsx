...
export default function Layout() {
  ...
  const navItem = ({ isActive }) => `bottom-nav-item${isActive ? ' active' : ''}`
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink to="/my-requests" className={({ isActive }) => `nav-item${isActive ? ' active' : ''}`}>
            <span className="nav-icon">{Icons.list}</span>My Requests
          </NavLink>
          <NavLink to="/rooms" className={({ isActive }) => `nav-item${isActive ? ' active' : ''}`}>
            <span className="nav-icon">{Icons.door}</span>Rooms
          </NavLink>
          {isAdmin && (
            <>
